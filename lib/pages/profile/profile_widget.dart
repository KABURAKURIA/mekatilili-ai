              ...
              children: [
                Align(
                  ...
                  child: Padding(
                    ...
                    child: wrapWithModel(
                      model: _model.lightDarkToggleModel,
                      updateCallback: () => setState(() {}),
                      child: LightDarkToggleWidget(),
                    ),
                  ),
                ),
                                  ...
                                  if (!revenue_cat.activeEntitlementIds
                                    ...
                                    return Align(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'PROFILE_PAGE_Container_sso0l35i_ON_TAP');
                                          logFirebaseEvent(
                                    ...
                                    return Align(
                                      ...
                                      child: Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'PROFILE_PAGE_Container_gmxfp19t_ON_TAP');
                                            logFirebaseEvent(
                                                'Container_haptic_feedback');
                                            HapticFeedback.lightImpact();
                                            logFirebaseEvent(
                            ...
                            child: Column(
                              ...
                              children: [
                                InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'PROFILE_PAGE_Container_c7e7x5kv_ON_TAP');
                                    logFirebaseEvent(
                                        'Container_haptic_feedback');
                                    HapticFeedback.lightImpact();
                                ...
                                Builder(
                                  builder: (context) => InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'PROFILE_PAGE_Container_z1ftcxry_ON_TAP');
                                      logFirebaseEvent(
                                          'Container_haptic_feedback');
                                      HapticFeedback.lightImpact();
                                ...
                                InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'PROFILE_PAGE_Container_ks4wvshj_ON_TAP');
                                    logFirebaseEvent(
                                        'Container_haptic_feedback');
                                    HapticFeedback.lightImpact();
                                    if (isiOS) {
                                ...
                                InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'PROFILE_PAGE_Container_t38vd1nv_ON_TAP');
                                    logFirebaseEvent(
                                        'Container_haptic_feedback');
                                    HapticFeedback.lightImpact();
                                    logFirebaseEvent(
                                ...
                                InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'PROFILE_PAGE_Container_8tbbosmx_ON_TAP');
                                    logFirebaseEvent(
                                        'Container_haptic_feedback');
                                    HapticFeedback.lightImpact();

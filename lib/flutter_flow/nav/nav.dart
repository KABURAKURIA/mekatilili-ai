      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => IndividualAlbumWidget(
            albumRef: params.getParam(
                'albumRef', ParamType.DocumentReference, false, ['albums']),
          ),
        ),
        FFRoute(
          name: 'Explore',
        ...
        FFRoute(
          ...
          builder: (context, params) => ImageDetailsWidget(
            ...
            fromCreation: params.getParam('fromCreation', ParamType.bool),
          ),
        ),
        FFRoute(
          name: 'Profile',
        ...
        FFRoute(
          ...
          path: '/imageGenerator',
          requireAuth: true,
          builder: (context, params) => ImageGeneratorWidget(
            initialPrompt: params.getParam('initialPrompt', ParamType.String),
          ),
        ),
        FFRoute(
          name: 'LoadingPage',
        ...
        FFRoute(
          ...
          path: '/postLoaded',
          requireAuth: true,
          builder: (context, params) => PostLoadedWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          path: '/imageStyles',
          requireAuth: true,
          builder: (context, params) => ImageStylesWidget(),
        ),
        FFRoute(
          name: 'ForgotPassword',
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/CleanShot_2023-12-05_at_09.21.45@2x.png',
                    fit: BoxFit.cover,
                  ),
                )
              : page;
